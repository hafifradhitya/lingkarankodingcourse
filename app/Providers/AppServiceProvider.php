...
use App\Repositories\StudentProgressRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Bind StudentProgressRepository
        $this->app->bind(StudentProgressRepositoryInterface::class, StudentProgressRepository::class);
